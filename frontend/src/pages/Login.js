...
function Login({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call onLogin, which is responsible for making the backend request
    ...
    <div className="grid w-auto h-[80vh] mt-8 border border-gray-700">
      ...
      <div className="flex flex-col justify-center items-center p-6">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          <div>
            <label htmlFor="username" className="block mb-2 text-md font-medium text-green-800">Username</label>
            <input
              id="username"
              type="text"
              value={username}
          ...
          <div>
            <label htmlFor="password" className="block mb-2 text-md font-medium text-green-800">Password</label>
            <input
              id="password"
              type="password"
              value={password}
